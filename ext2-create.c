...
void write_hello_world_file_block(int fd) {
	...
	char* writetofile = "Hello world\n";

	if(write(fd, writetofile, strlen(writetofile)) != strlen(writetofile)){
		errno_exit("file write");
	}
}
